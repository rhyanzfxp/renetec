...
export const ApontamentoLoteItemSchema = z.object({
  ...
  quantidadeReparada: z.coerce.number().int().min(0).optional().default(0),
  quantidadeSemDefeito: z.coerce.number().int().min(0).optional().default(0),
  quantidadeSucata: z.coerce.number().int().min(0).optional().default(0),
